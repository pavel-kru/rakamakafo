...
function styles() {
  return (
    src(["app/scss/**/*.scss", "!app/scss/**/_*.scss"]) // Выбираем источник: "app/sass/main.sass" или "app/less/main.less"
      ...
      // Конкатенируем в один файл // Конкатенируем в файл app.min.js
